...
import { Fingerprint, Activity, Lock, Globe, Shield } from 'lucide-react';
...
const ReflectiveCard = ({
  ...
  clientDetails = [
    { label: 'ORGANIZATION', value: 'NEURAL HANDSHAKE' },
    { label: 'CLEARANCE', value: 'LEVEL 5 / OMNI' },
    { label: 'REGION', value: 'GLOBAL-STATIC' }
  ]
}) => {
        ...
        <div className="card-body">
          ...
          <div className="client-details-grid">
            {clientDetails.map((detail, idx) => (
              <div key={idx} className="client-detail-item">
